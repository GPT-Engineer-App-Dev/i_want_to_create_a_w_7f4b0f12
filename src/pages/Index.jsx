  ...
  return (
    <Box p={8}>
      ...
      <Box bg="gray.200" h="300px" borderRadius="md" mb={6} p={4} position="relative">
        ...
        <Image src="https://images.unsplash.com/photo-1596025015373-fc39b4d4de2a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1MDcxMzJ8MHwxfHNlYXJjaHwxfHxtYXAlMjBwbGFjZWhvbGRlcnxlbnwwfHx8fDE3MTI1NDM1ODB8MA&ixlib=rb-4.0.3&q=80&w=1080" objectFit="cover" borderRadius="md" />
